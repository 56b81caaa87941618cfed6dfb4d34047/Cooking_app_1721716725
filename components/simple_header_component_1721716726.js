    ...
    <div class="flex">
        <aside class="w-64 h-screen bg-gray-100 dark:bg-gray-800">
            <div class="p-4">
                ...
                <ul class="mt-4">
                    <li class="mb-2">
                        <a href="#" class="text-gray-600 hover:text-purple-700 dark:text-gray-300 dark:hover:text-white">Recipes</a>
                    </li>
                    <li class="mb-2">
                        <a href="#" class="text-gray-600 hover:text-purple-700 dark:text-gray-300 dark:hover:text-white">Meal Plans</a>
                    </li>
                    <li class="mb-2">
                        <a href="#" class="text-gray-600 hover:text-purple-700 dark:text-gray-300 dark:hover:text-white">Grocery Lists</a>
                    </li>
                    <li class="mb-2">
                        <a href="#" class="text-gray-600 hover:text-purple-700 dark:text-gray-300 dark:hover:text-white">Cooking Guides</a>
                    </li>
                </ul>
            </div>
        </aside>
                    ...
                    <div id="nav-container" class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                        ...
                        <div id="mobile-menu-2" class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1">
                            <ul id="nav-list" class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                                <li id="nav-item-home"><a href="#" class="block py-2 pl-3 pr-4 text-white bg-purple-700 rounded lg:bg-transparent lg:text-purple-700 lg:p-0 dark:text-white" aria-current="page">Explore delicious recipes</a></li>
