...
// 1. In the user app html file, include `<chatbot_1721720353></chatbot>` in the place where the chart needs to be inserted.
    ...
    <div>
        ...
        <div id="main-chat-container" ref="chatContainer" class="flex fixed bottom-16 left-2 px-8 bg-gray-200 bg-opacity-50 blur-lg rounded-lg overflow-y-auto" v-show="showChat">
            <div class="rounded-lg p-4 flex-grow-1">
                ...
                <button class="bg-purple-500 text-white px-4 py-2 rounded-md mr-2 hover:bg-purple-600 transition duration-300">Nine</button>
